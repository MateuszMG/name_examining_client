...
import { domainUrl, loginData, testId } from '../../../../support/helpers';
...
describe('<Login />', () => {
  ...
  describe('api actions', () => {
    it('should login', () => {
      ...
      cy.get(testId('input__username')).type(loginData.username);
      cy.get(testId('input__password')).type(loginData.password);

      cy.get(testId('button__submit')).click();

      cy.get(testId('page_login')).should('not.exist');
